...
const user = {
    state: {
        ...
        uploadUserInfo: '', // 上传图片信息接口
        inCooperationSignUpNum: uni.getStorageSync('inCooperationSignUpNum') ? uni.getStorageSync('inCooperationSignUpNum') : '', // 合作中通告数
        wxJsSignatureInfo: null // JS-SDK使用权限签名算法
    },
    actions: {
        // 获取又拍云配置信息
        getUploadUserInfo({
            ...
            return new Promise((resolve, reject) => {
                upaiyunUploadInfoGet().then(response => {
                    let uploadUserInfo = {
    ...
    mutations: {
        ...
        SET_IN_COOPERATION_SIGNUP_NUM: (state, inCooperationSignUpNum) => {
            state.inCooperationSignUpNum = inCooperationSignUpNum
            uni.setStorageSync('inCooperationSignUpNum', inCooperationSignUpNum)
        },
    ...
    getters: {
        ...
        inCooperationSignUpNum: state => state.inCooperationSignUpNum,
